...
import { createGuildLootListEntry, deleteGuildLootListEntry, getGuildLootListSummary, listGuildLootListEntries, updateGuildLootListEntry } from '../services/lootListService.js';
const sortFields = ['itemName', 'itemId', 'createdAt'];
export async function lootListRoutes(server) {
