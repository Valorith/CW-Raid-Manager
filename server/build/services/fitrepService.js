...
// ─── Report CRUD ───────────────────────────────────────────────────
export async function listReports(guildId, filters) {
    const where = { guildId };
    if (filters?.status)
        where.status = filters.status;
    if (filters?.rateeUserId)
        where.rateeUserId = filters.rateeUserId;
...
// ─── Example Reports ───────────────────────────────────────────────
export async function listExamples(guildId, userId) {
