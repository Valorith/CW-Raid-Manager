  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    .ops-overview {
      ...
      border-radius: 8px;
      background:
        linear-gradient(120deg, rgba(53, 221, 139, 0.08), transparent 42%),
        linear-gradient(90deg, transparent, rgba(106, 168, 255, 0.08)),
    ...
    /* Professional cockpit overhaul. Keep the old class contracts intact because
       the page is generated by this script and refreshed in place. */
    :root {
      --bg: #080a0b;
      --bg-2: #0e1011;
      --panel: #151819;
      ...
      --line-strong: rgba(224, 230, 226, 0.24);
      --text: #f4f7f4;
      --muted: #9ca7a0;
      --soft: #d4ddd7;
      --green: #42e68f;
      ...
      --control: #202526;
      --control-hover: #2a3031;
      --card-shadow: 0 18px 42px rgba(0, 0, 0, 0.36);
      --card-shadow-soft: 0 10px 26px rgba(0, 0, 0, 0.24);
      --radius: 8px;
    }
    body {
      background:
        ...
        linear-gradient(180deg, #090b0b 0%, #101414 38%, #0a0d0d 100%);
      background-size: 64px 64px, 64px 64px, auto;
      color: var(--text);
      font: 14px/1.46 Inter, ui-sans-serif, system-ui, -apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif;
      letter-spacing: 0;
    }
    header {
      border-bottom: 1px solid rgba(224, 230, 226, 0.11);
      background: rgba(8, 10, 11, 0.84);
      backdrop-filter: blur(20px) saturate(130%);
      box-shadow: 0 1px 0 rgba(255, 255, 255, 0.035), 0 18px 46px rgba(0, 0, 0, 0.22);
    }
    .shell {
    ...
    .user {
      border: 1px solid rgba(224, 230, 226, 0.12);
      border-radius: var(--radius);
      padding: 8px 10px;
      background: rgba(21, 24, 25, 0.68);
    ...
    .user img {
      ...
      height: 38px;
      border-radius: 8px;
      border-color: rgba(224, 230, 226, 0.18);
    }
    .user a {
      color: var(--teal);
      font-weight: 750;
    ...
    button {
      ...
      background: linear-gradient(180deg, #252b2c, #1a1f20);
      color: var(--text);
      padding: 0 13px;
      font-weight: 850;
      box-shadow: inset 0 1px 0 rgba(255, 255, 255, 0.06), 0 1px 1px rgba(0, 0, 0, 0.22);
    }
    button:hover {
      border-color: rgba(69, 216, 192, 0.52);
      background: linear-gradient(180deg, #2d3435, #202627);
    ...
    textarea:focus,
    select:focus {
      outline: 2px solid rgba(69, 216, 192, 0.5);
      outline-offset: 2px;
      border-color: rgba(69, 216, 192, 0.72);
    }
    button.primary {
      color: #052315;
      background: linear-gradient(180deg, #62f3a2, #35cf82);
      border-color: rgba(98, 243, 162, 0.68);
    }
    button.good {
      color: #052315;
      background: linear-gradient(180deg, #62f3a2, #2abf73);
      border-color: rgba(98, 243, 162, 0.68);
    }
    button.warn {
      color: #221403;
      background: linear-gradient(180deg, #ffdb7a, #c98b23);
      border-color: rgba(255, 219, 122, 0.5);
    }
    button.danger {
      color: #fff5f7;
      background: linear-gradient(180deg, #b63348, #812235);
      border-color: rgba(255, 100, 124, 0.58);
    }
    button.ghost,
    .readiness-button {
      background: rgba(26, 31, 32, 0.74);
      border-color: rgba(224, 230, 226, 0.12);
      color: var(--soft);
      box-shadow: inset 0 1px 0 rgba(255, 255, 255, 0.035);
    }
    button.ghost:hover,
    .readiness-button:hover {
      background: rgba(38, 45, 46, 0.88);
      color: var(--text);
    }
    input, textarea, select {
      border-radius: var(--radius);
      border-color: rgba(224, 230, 226, 0.15);
      background: #0d1010;
      color: var(--text);
    ...
    .ops-overview {
      grid-template-columns: minmax(0, 0.86fr) minmax(0, 1.2fr) minmax(0, 0.94fr);
      border-color: rgba(224, 230, 226, 0.14);
      border-radius: var(--radius);
      background:
        linear-gradient(120deg, rgba(21, 24, 25, 0.98), rgba(19, 23, 23, 0.96)),
        #151819;
    ...
    .ops-overview::after {
      ...
      inset: 0;
      pointer-events: none;
      background: linear-gradient(90deg, rgba(66, 230, 143, 0.08), transparent 31%, rgba(127, 178, 255, 0.07));
      opacity: 0.9;
    }
    .ops-overview {
      position: relative;
    ...
    .ops-pane + .ops-pane {
      border-left-color: rgba(224, 230, 226, 0.1);
    }
    .ops-state {
      gap: 14px;
    }
    .ops-orb {
      ...
      height: 44px;
      border-radius: var(--radius);
      border-color: rgba(66, 230, 143, 0.26);
      background: rgba(66, 230, 143, 0.1);
    ...
    .ops-track {
      height: 7px;
      background: rgba(224, 230, 226, 0.12);
    }
    .ops-track span {
      background: linear-gradient(90deg, #42e68f, #45d8c0, #7fb2ff);
    }
    .ops-stat-rail {
    ...
    .ops-divider {
      background: rgba(224, 230, 226, 0.1);
    }
    .brand-mark {
      width: 24px;
      height: 24px;
    ...
    .brand-mark.codex {
      background: #101313;
      border-color: rgba(224, 230, 226, 0.17);
    }
    .panel,
    .runner-card,
    .history-row,
    ...
    .metrics-kpi {
      border-radius: var(--radius);
      border-color: rgba(224, 230, 226, 0.13);
    ...
    .panel-head {
      min-height: 58px;
      padding: 15px 17px;
      background: linear-gradient(180deg, rgba(31, 36, 37, 0.96), rgba(21, 24, 25, 0.93));
      border-bottom-color: rgba(224, 230, 226, 0.12);
    }
    .panel-body {
      padding: 17px;
      gap: 14px;
    ...
    .runner-card {
      grid-template-columns: minmax(280px, 1.12fr) repeat(3, minmax(112px, 0.42fr)) minmax(230px, 0.78fr);
      gap: 16px;
      padding: 17px;
      background:
        linear-gradient(180deg, rgba(26, 31, 32, 0.96), rgba(18, 22, 22, 0.96)),
        #151819;
      cursor: pointer;
      box-shadow: var(--card-shadow-soft);
    }
    ...
    .runner-card:hover {
      border-color: rgba(69, 216, 192, 0.42);
      background:
        linear-gradient(180deg, rgba(32, 38, 39, 0.98), rgba(20, 25, 25, 0.98)),
        #171b1b;
    ...
    .runner-actions button {
      min-height: 31px;
      border-color: rgba(224, 230, 226, 0.1);
      background: rgba(29, 34, 35, 0.74);
      color: var(--soft);
      font-weight: 850;
    }
    .runner-actions button:hover {
      background: rgba(42, 49, 50, 0.9);
      border-color: rgba(69, 216, 192, 0.34);
    }
    .runner-actions button.primary {
      color: #052315;
      background: rgba(66, 230, 143, 0.82);
    }
    .runner-actions button.warn {
      color: #2a1904;
    ...
    .runner-actions button.danger {
      color: #fff5f7;
      background: rgba(136, 34, 54, 0.82);
    }
    .detail-head {
      align-items: center;
      margin-bottom: 16px;
    ...
    .control-summary {
      border-color: rgba(224, 230, 226, 0.12);
      background: linear-gradient(180deg, rgba(31, 37, 38, 0.86), rgba(11, 14, 14, 0.32));
    }
    .control-section {
      border-top-color: rgba(224, 230, 226, 0.1);
      gap: 10px;
    }
    .control-actions {
      gap: 9px;
    ...
    .metric-row {
      min-height: 32px;
      border-bottom: 1px solid rgba(224, 230, 226, 0.07);
    }
    .metric-list .metric-row:last-child {
      border-bottom: 0;
    }
    .metric-row span {
      color: #aab5ad;
    ...
    .integration-status-main {
      display: flex;
      align-items: center;
      gap: 10px;
      min-width: 0;
    }
    .integration-status-main > div {
      display: grid;
      gap: 2px;
      min-width: 0;
    }
    .integration-status-main strong,
    .integration-status-main a {
      color: var(--text);
      font-size: 13px;
      font-weight: 850;
      overflow: hidden;
    ...
    .advanced-controls:not([open]) .advanced-body {
      display: none;
    }
    .advanced-body {
      display: grid;
      gap: 13px;
      padding: 13px;
      border-top: 1px solid rgba(224, 230, 226, 0.1);
    ...
    .metric-list.compact {
      gap: 0;
      border: 1px solid rgba(224, 230, 226, 0.08);
      border-radius: var(--radius);
      overflow: hidden;
      background: rgba(8, 10, 11, 0.18);
    }
    ...
    .status-dot.paused {
      background: var(--amber);
      animation: pulse-amber 2.1s infinite;
    }
    .activity-bar {
      height: 5px;
      background: rgba(224, 230, 226, 0.11);
    }
    .activity-bar span {
      background: linear-gradient(90deg, #45d8c0, #42e68f, #7fb2ff);
    }
    .grid {
      gap: 11px;
    }
    ...
    .history-row {
      grid-template-columns: minmax(0, 1fr) 98px minmax(120px, 0.25fr) 130px;
      padding: 13px;
      background: rgba(18, 22, 22, 0.86);
    }
    .history-row:hover {
      border-color: rgba(127, 178, 255, 0.26);
      background: rgba(24, 29, 30, 0.95);
    }
    .history-main {
      gap: 6px;
    }
    ...
    .health-card,
    .metrics-kpi {
      background: linear-gradient(180deg, rgba(28, 33, 34, 0.96), rgba(18, 22, 22, 0.94));
    }
    .health-card strong,
    .metrics-kpi strong {
      font-size: clamp(24px, 2.1vw, 34px);
    ...
    .meter-fill,
    .distribution-fill {
      background: linear-gradient(90deg, #7fb2ff, #45d8c0);
    }
    .chart-card {
      padding: 16px;
    }
    .line-chart {
      border-color: rgba(224, 230, 226, 0.11);
      background:
        linear-gradient(rgba(224, 230, 226, 0.05) 1px, transparent 1px),
        linear-gradient(90deg, rgba(224, 230, 226, 0.05) 1px, transparent 1px),
        rgba(8, 10, 11, 0.25);
    }
    .bar-stack {
      background: rgba(224, 230, 226, 0.11);
    ...
    .preflight-head {
      border-bottom-color: rgba(224, 230, 226, 0.11);
      background: rgba(28, 33, 34, 0.72);
    }
    .preflight-ring {
      width: 38px;
      height: 38px;
      border-radius: var(--radius);
      border-color: rgba(66, 230, 143, 0.3);
      background: rgba(66, 230, 143, 0.12);
    }
    .preflight-grid {
      background: rgba(224, 230, 226, 0.09);
    }
    .preflight-check {
    ...
    .preflight-aside {
      border-left-color: rgba(224, 230, 226, 0.11);
      background: rgba(8, 10, 11, 0.22);
    }
    .modal {
    ...
    @media (max-width: 620px) {
      ...
      .ops-stat:nth-child(even) {
        border-left: 1px solid rgba(224, 230, 226, 0.1);
      }
      .ops-stat:nth-child(n + 3) {
        border-top: 1px solid rgba(224, 230, 226, 0.1);
      }
      .runner-actions {
        grid-template-columns: repeat(2, minmax(0, 1fr));
...
<body>
  ...
  <script>
    ...
    function renderIntegrationStatus(kind, title, status, active, detail, href) {
      const titleHtml = href
        ? '<a href="' + escapeHtml(href) + '" target="_blank" rel="noreferrer">' + escapeHtml(title) + '</a>'
        : escapeHtml(title);
      return '<div class="integration-status">' +
        '<div class="integration-status-main">' +
          renderBrandMark(kind) +
          '<div><strong>' + titleHtml + '</strong><span>' + escapeHtml(detail || (active ? 'Ready' : 'Needs attention')) + '</span></div>' +
        '</div>' +
        renderBadge(status, active ? 'active' : 'inactive') +
      '</div>';
    }
    ...
    function renderPoolControlSection(runner) {
      ...
      return '<div class="advanced-group">' +
        ...
        '<div class="metric-list compact">' +
          ...
          renderMetricRow('Manager', managerState) +
          instanceRows +
          actionRows +
        '</div>' +
    ...
    function renderControlMetric(label, value, detail) {
      const normalized = value === 0 ? '0' : value;
      return '<div class="control-metric">' +
        '<span>' + escapeHtml(label) + '</span>' +
        '<strong>' + escapeHtml(normalized || 'none') + '</strong>' +
        (detail ? '<small>' + escapeHtml(detail) + '</small>' : '') +
      '</div>';
    }

    function renderRunnerPoolSnapshot(runner) {
      const pool = latestPool;
      const poolStats = pool?.pool || {};
      const poolConfig = pool?.config || {};
      const queue = pool?.queue || {};
      ...
      return '<section class="control-section">' +
        '<div class="control-section-title"><span>Pool status</span>' + renderBadge(managerState, managerState === 'active' ? 'active' : 'inactive') + '</div>' +
        '<div class="control-metric-grid">' +
          renderControlMetric('Queued', queue.queued ?? '0') +
          renderControlMetric('Target', poolStats.target !== undefined ? poolStats.target + ' / ' + (poolConfig.maxRunners ?? 'unknown') : 'unknown') +
          renderControlMetric('Active', poolStats.active ?? '0') +
          renderControlMetric('Unit', instance ? instance.unit : runner.runnerId.startsWith('${escapeJsString(config.runnerPoolPrefix)}') ? 'pool' : 'baseline') +
        '</div>' +
      '</section>';
    }
    ...
    function renderSelectedRunner() {
      ...
      runnerMetricsEl.innerHTML =
        ...
        '<section class="control-section">' +
          '<div class="control-section-title"><span>Connections</span></div>' +
          '<div class="integration-status-list">' +
            renderIntegrationStatus(
              ...
              runner.executionMode === 'cloud-hybrid'
                ? 'Diffs apply through this runner'
        ...
        '</section>' +
        '<section class="control-section">' +
          '<div class="control-section-title"><span>Primary actions</span></div>' +
          '<div class="control-actions primary-actions">' +
          ...
          '<details class="advanced-controls">' +
            ...
            '<div class="advanced-body">' +
              '<div class="advanced-group">' +
                '<h3>Runner service</h3>' +
                '<div class="metric-list compact">' +
                  renderMetricRow('Service', runnerService?.active || 'unknown') +
                ...
                '</div>' +
                '<div class="control-actions compact-actions">' +
                  '<button data-service-action="start">Start service</button>' +
                  '<button class="warn" data-service-action="restart">Restart service</button>' +
                  '<button class="danger" data-service-action="stop">Stop service</button>' +
                '</div>' +
              '</div>' +
              '<div class="advanced-group">' +
                ...
                '</div>' +
                '<div class="control-actions compact-actions">' +
                  '<button class="warn" data-runner-action="restart" data-runner-id="' + escapeHtml(runner.runnerId) + '">Restart runner</button>' +
                '</div>' +
              '</div>' +
